<%@ Page Title="" Language="C#" MasterPageFile="~/sanjeevanAdmin/MasterAdmin.master" AutoEventWireup="true" CodeFile="notes.aspx.cs" Inherits="sanjeevanAdmin_notes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="space50"></span>
    <h2 class="pgTitle">Subject Notes</h2>
    <span class="space30"></span>
    
    <div class="formPanel">
        <span class="space20"></span>
        <h4 class="formTitle themeDarkBg">Add Subject Notes Photos</h4>
        ...
        <div class="pad_10">
            ...
            <span class="labelCap">Select Subject:*</span>
